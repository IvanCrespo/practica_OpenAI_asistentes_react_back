...
export class GptController {
  ...
  orthograpthyCheck(@Body() orthographyDto: OrthographyDto) {
    return this.gptService.orthograpthyCheck(orthographyDto);
  }

  @Post('pros-cons-discusser')
  prosConsDiscusserDto(@Body() prosConsDiscusserDto: ProsConsDiscusserDto) {
    return this.gptService.prosConsDiscusser(prosConsDiscusserDto);
  }

  @Post('pros-cons-discusser-stream')
  async prosConsDiscusserDtoStream(@Body() prosConsDiscusserDto: ProsConsDiscusserDto, @Res() res: Response) {
  ...
  @Post('text-to-audio')
  async textToAudio(
    @Body() textToAudioDto: TextToAudioDto, @Res() res: Response
  ) {
  ...
  async textToAudioGetter(
    @Res() res: Response, @Param('fileId') fileId: string
  ) {
